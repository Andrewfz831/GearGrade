            ...
            <form className="mt-8 space-y-6" action="#">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="remember" className="font-medium text-gray-500 dark:text-gray-400">I agree with the <Link to="" className='text-green-600 hover:underline dark:text-green-500'>terms and conditions</Link></label>
                </div>
              </div>
              <button
                type="submit"
              ...
              <div className="text-sm font-medium text-gray-900 dark:text-white">
                Already have an account? <Link to="/Login" className="text-green-600 hover:underline dark:text-green-500">Login Here!</Link>
              </div>
            </form>
          </div>
        </div>
