  ...
  return (
    <div className='shadow-md w-full fixed top-0 left-0'>
      ...
      <div className='font-bold text-2xl cursor-pointer flex items-center text-gray-800'>
        ...
        <Link to="/Login">
        <button type="button" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 md:hidden">Login</button>
        </Link>
      </div>
      <div onClick={()=>setOpen(!open)} className='flex flex-row text-3xl  absolute right-8 top-6 cursor-pointer md:hidden'>
      <TfiMenu name={open ? 'close':'menu'} className=" text-grey-900 dark:text-green-500" ></TfiMenu>
      </div>
      ...
      <Link to="/Login">
      <button type="button" className='text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 md:inline-block hidden'>Login</button>
      </Link>
      </div>
    </div>
  )
